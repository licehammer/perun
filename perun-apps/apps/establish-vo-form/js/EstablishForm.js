...
var voFormItems = [{
    ...
    "forDelete":false,
    "i18n":{
        "en":{"locale":"en","label":"<p>You are already a member of this VO. Please continue to a <a href=\"https://perun-eduteams.cesnet.cz/\">eduTEAMS Perun info page</a> to discover more.</p>","options":null,"help":"","errorMessage":""},
        "cs":{"locale":"cs","label":"<p>Již jste členem této virtuální organizace. Prosím pokračujte na <a href=\"https://perun-eduteams.cesnet.cz/\">informační stánku o Perunovi v eduTEAMS</a>, kde se dozvíte více.</p>","options":null,"help":"","errorMessage":""}
    },
    "beanName":"ApplicationFormItem"
}];
