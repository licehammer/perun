 ...
 *
 */
public class urn_perun_user_attribute_def_virt_login_namespace_eduteams_nickname_view extends UserVirtualAttributesModuleAbstract {

	public static final String SHADOW = "urn:perun:user:attribute-def:def:login-namespace:eduteams-nickname";
	...
	public AttributeDefinition getAttributeDefinition() {
		...
		attr.setFriendlyName("login-namespace:eduteams-nickname-view");
